...
- **Finance** — Dashboard de suivi et trading automatise (a venir)
- **Sante** — Agents virtuels conseil + dashboard de suivi (a venir)
...
Void Glass : fond #06070C, Figtree (UI), JetBrains Mono (code)
