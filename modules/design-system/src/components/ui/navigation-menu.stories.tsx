      ...
      <NavigationMenuList>
        <NavigationMenuItem>
          ...
          <NavigationMenuContent className="p-ds-4 w-[420px]">
            <div className="grid gap-ds-2">
              <NavigationMenuLink className="block rounded-ds-md p-ds-2 hover:bg-ds-surface-2/60">
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent className="p-ds-4 w-[280px]">
            <NavigationMenuLink className="block rounded-ds-md p-ds-2 hover:bg-ds-surface-2/60 text-ds-base">Knowledge</NavigationMenuLink>
            <NavigationMenuLink className="block rounded-ds-md p-ds-2 hover:bg-ds-surface-2/60 text-ds-base">Changelog</NavigationMenuLink>
          </NavigationMenuContent>
        </NavigationMenuItem>
      </NavigationMenuList>
    </NavigationMenu>
