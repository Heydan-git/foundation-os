...
> Data · `chart` · Foundation OS DS

## Role

Wrapper Recharts v3. ChartContainer fournit legend/tooltip. Voir stories pour examples line/bar/area.

## Import

```tsx
import { Chart } from '@foundation-os/design-system';
```
...
Source : `modules/design-system/src/components/ui/chart.tsx`
Stories : `modules/design-system/src/components/ui/chart.stories.tsx`
