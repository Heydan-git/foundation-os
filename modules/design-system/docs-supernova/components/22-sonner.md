...
> Feedback · `sonner` · Foundation OS DS

## Role

Toast non-bloquant. Success/info/warning/error. Auto-dismiss 4s, action optionnelle.

## Import

```tsx
import { Sonner } from '@foundation-os/design-system';
```
...
Source : `modules/design-system/src/components/ui/sonner.tsx`
Stories : `modules/design-system/src/components/ui/sonner.stories.tsx`
