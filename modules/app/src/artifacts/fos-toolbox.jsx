...
const OPS=[
  ...
  {i:"🧪",t:"C'est prêt ? Vérifie tout",
   ...
   steps:[
     {a:"Review R1-R8",tl:"@review-agent · /sync-md",d:"R1 taille, R2 régression, R3 DA, R4 MD pairs, R5 stack, R6 notations, R7 versions, R8 storage keys."},
...
const MNT=[
  ...
  {i:"🔍",t:"Fais un audit complet du système",
   ...
   steps:[
     ...
     {a:"Vérifier références croisées",tl:"@review-agent · /sync-md · bmad-index-docs",d:"ADR, versions, tailles — tout doit correspondre."},
  ...
  {i:"🧬",t:"Propose des améliorations de l'OS",
   ...
   steps:[
     ...
     {a:"Exécuter si validé",tl:"@doc-agent → @dev-agent → @review-agent → /sync-md",d:"MD first → JSX → R1-R8 → commit conventionnel."},
     {a:"Propager",tl:"Notion · Asana · MONITORING · SKILL.md · KB",d:"Tous systèmes synchronisés. Changelog. Version bumpée."},
     {a:"Vérifier zéro régression",tl:"@review-agent · /sync-md · Vercel preview",d:"Avant/après sur chaque fichier. 0 régression → git push."},
   ]},
  {i:"🔁",t:"Mets à jour X sans casser Y",
   ...
   steps:[
     {a:"Snapshot état actuel",tl:"FOS-MONITORING · /sync-md · git status",d:"Versions MD, tailles JSX, storage keys, checkpoints."},
     ...
     {a:"Vérification post-deploy",tl:"Vercel preview · /sync-md · MONITORING",d:"Snapshot avant vs après → ZÉRO régression confirmé."},
   ]},
  {i:"📝",t:"Crée ou modifie un artifact fos-*",
   ...
   steps:[
     ...
     {a:"Livrer ensemble",tl:"@review-agent · /sync-md · commit · push",d:"MD + JSX même commit. Vercel auto-deploy. Update MONITORING."},
   ]},
  {i:"🔗",t:"Vérifie que tout est synchronisé",
   w:"Cohérence MD/JSX/Notion/Asana/monitoring.",
   ex:"\"Sync check\" · \"Propage vers Notion\"",
   steps:[
     {a:"Audit 7 pairs MD↔JSX",tl:"/sync-md · @review-agent",d:"Version, storage key, taille <700L, DA tokens, 0 désync."},
  ...
  {i:"🔄",t:"RALPH Loop — amélioration continue",
   ...
   steps:[
     ...
     {a:"H — Harmonize tous les systèmes",tl:"/sync-md · Notion · Asana · MONITORING · SKILL.md",d:"MD↔JSX alignés. Externes à jour. Versions cohérentes. Puis → recommencer."},
   ]},
  ...
  {i:"📋",t:"On arrête pour aujourd'hui",
   ...
   steps:[
     ...
     {a:"Sync check final",tl:"/sync-md · @review-agent",d:"TOUS les MD/JSX alignés."},
...
const INV=[
  ...
  {cat:"⚡ Commandes & Hooks",ct:"9 cmd + 3 hooks",color:C.yl,items:[
    ...
    "/session-end → git status→/sync-md→JOURNAL→MONITORING→Notion→next step",
    "/new-project → projects/[nom]/ (CONTEXT+JOURNAL+BACKLOG) → sync Asana",
    "/sync-md → audit 7 pairs MD↔JSX (version, key, taille, DA, sync)",
