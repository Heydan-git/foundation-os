...
export const FRAMEWORKS: Framework[] = [
  {
    id: 'BMAD', label: 'BMAD v6', tag: 'Process', tagColor: 'var(--color-accent-brand-secondary)',
    lines: [
  ...
  {
    id: 'CLAUDIFY', label: 'Claudify', tag: 'Execution', tagColor: 'var(--color-accent-brand-primary)',
    lines: [
  ...
  {
    id: 'HYBRIDE', label: 'Hybride', tag: 'Recommande', tagColor: 'var(--color-accent-success)',
    lines: [
...
export const STACK: StackLayer[] = [
  {
    id: 'L1', label: 'L1 · Setup L1a + L1b', status: 'files_ready', statusColor: 'var(--color-accent-warning)',
    sublayers: [
  ...
  {
    id: 'L2', label: 'L2 · Claude Code', status: 'configured', statusColor: 'var(--color-accent-success)',
    sublayers: [],
  ...
  {
    id: 'L3', label: 'L3 · BMAD v6', status: 'installed', statusColor: 'var(--color-accent-brand-primary)',
    sublayers: [],
  ...
  {
    id: 'L4', label: 'L4 · MCP Plugins', status: 'connected', statusColor: 'var(--color-accent-brand-primary)',
    sublayers: [],
...
export const ROADMAP: RoadmapItem[] = [
  { id: 'v0.1', label: 'v0.1', date: '02.04.26', status: 'done', color: 'var(--color-accent-success)', desc: 'Manifeste · Journal · Memoire 4 couches · Garde-fous · Frameworks analyses' },
  { id: 'phase1', label: 'Phase 1', date: '05.04.26', status: 'done', color: 'var(--color-accent-success)', desc: 'Fondations : CLAUDE.md v2, security-guidance, gstack, index navigation' },
  { id: 'phase2', label: 'Phase 2', date: '07.04.26', status: 'active', color: 'var(--color-accent-brand-primary)', desc: 'App Hardening : 16 tests, Navbar, Auth complete, integration artifacts' },
  { id: 'phase3', label: 'Phase 3', date: 'a venir', status: 'pending', color: 'var(--color-text-muted)', desc: 'OS Intelligence : session-end 4 niveaux, audit BMAD/OMC, doc index' },
  { id: 'phase4', label: 'Phase 4', date: 'a venir', status: 'pending', color: 'var(--color-text-muted)', desc: 'Monitoring : pre-commit health-check, bundle size tracking' },
  { id: 'phase5', label: 'Phase 5', date: 'a venir', status: 'pending', color: 'var(--color-text-muted)', desc: 'Expansion : premier nouveau module (Finance, Sante ou Trading)' },
]
