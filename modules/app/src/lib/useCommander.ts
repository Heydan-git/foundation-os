...
const SEED_SESSIONS: Session[] = [
  { id: 'CONV-001', created_at: '2026-04-02T10:00:00Z', date: '2026-04-02', title: 'Fondation — Vision & Principes', items: 'Mode coopération défini · Vision LT fondation mondiale · Analyse Claudify + BMAD · FONDATION_v0.md créé', decisions: 'Coopération > exploitation · Traçabilité totale · Claudify + BMAD = fondations' },
  { id: 'CONV-002', created_at: '2026-04-02T14:00:00Z', date: '2026-04-02', title: 'Skills iOS Pipeline Grade A', items: '18+ skills cartographiés · Pipeline 8 phases × 3 budgets · ios-pipeline-dashboard.jsx · 12 fichiers MD', decisions: '8 phases validation→growth · Stack iOS : Swift 6 + SwiftUI + TCA' },
  { id: 'CONV-003', created_at: '2026-04-03T09:00:00Z', date: '2026-04-03', title: 'Architecture Foundation OS', items: 'Analyse exhaustive 10 artifacts · Architecture 6 artifacts cibles · Design System Void Glass formalisé', decisions: '6 artifacts fos-* · BMAD v6 _bmad/ (underscore) · DS Void Glass = spec Figma' },
  ...
  { id: 'CONV-005', created_at: '2026-04-04T08:00:00Z', date: '2026-04-04', title: 'App Foundation OS — Commander Page', items: 'Page Commander fonctionnelle · Supabase connecté · Routing /commander · Déployé Vercel', decisions: 'react-router-dom · Supabase tables créées · Void Glass strict' },
]

const SEED_DECISIONS: Decision[] = [
  { id: 'ADR-001', code: 'COOP', created_at: '2026-04-02T10:00:00Z', date: '2026-04-02', title: 'Coopération > exploitation',            context: 'Philosophie Foundation OS',                              impact: 'high',   status: 'active' },
  { id: 'ADR-002', code: 'TRACE', created_at: '2026-04-02T10:05:00Z', date: '2026-04-02', title: 'Traçabilité totale',                    context: 'Journal + MD + monitoring systématique',                 impact: 'high',   status: 'active' },
  { id: 'ADR-003', code: 'EVOL', created_at: '2026-04-02T10:10:00Z', date: '2026-04-02', title: 'Plan évolutif',                         context: 'Itérations courtes, pas de rigidité',                    impact: 'medium', status: 'active' },
  { id: 'ADR-004', code: 'FLOW', created_at: '2026-04-02T10:15:00Z', date: '2026-04-02', title: 'Claudify + BMAD = fondations workflow', context: 'Déploiement sur Claude.ai Projects après préparation',   impact: 'high',   status: 'active' },
  { id: 'ADR-005', code: 'ARCH', created_at: '2026-04-03T09:00:00Z', date: '2026-04-03', title: 'Architecture MD/JSX',                   context: 'MD = source de vérité, JSX = contrôleur',                impact: 'high',   status: 'active' },
  { id: 'ADR-006', code: 'ART6', created_at: '2026-04-03T09:05:00Z', date: '2026-04-03', title: '6 artifacts fos-*',                     context: 'Architecture cible après analyse exhaustive',            impact: 'high',   status: 'active' },
  { id: 'ADR-007', code: 'HYBR', created_at: '2026-04-03T09:10:00Z', date: '2026-04-03', title: 'Option D Hybrid',                       context: 'Pipeline app iOS — Hybrid artifacts + app',             impact: 'high',   status: 'active' },
  { id: 'ADR-008', code: 'STCK', created_at: '2026-04-03T09:15:00Z', date: '2026-04-03', title: 'Vercel + Supabase',                     context: 'Stack L5 définitive — free tier suffisant usage perso',  impact: 'high',   status: 'active' },
  { id: 'ADR-009', code: 'SETP', created_at: '2026-04-03T09:20:00Z', date: '2026-04-03', title: '22 étapes setup orchestrées',           context: 'Plan déploiement Foundation OS complet',                 impact: 'high',   status: 'active' },
  { id: 'ADR-010', code: 'SKIL', created_at: '2026-04-03T09:25:00Z', date: '2026-04-03', title: 'FOUNDATION-OS-SKILL = mémoire',         context: 'Skill pour maintien cohérence long terme',               impact: 'high',   status: 'active' },
  { id: 'ADR-011', code: 'OMCT', created_at: '2026-04-03T09:30:00Z', date: '2026-04-03', title: 'OMC team syntax canonical (v4.1.7+)',   context: 'team "tâche" — swarm/ultrapilot supprimés',              impact: 'medium', status: 'active' },
  { id: 'ADR-012', code: 'L1L2', created_at: '2026-04-03T09:35:00Z', date: '2026-04-03', title: 'L1 = deux couches',                     context: 'Architecture L1 clarifiée',                              impact: 'high',   status: 'active' },
]
