...
const SEED_DOCS: Doc[] = [
  ...
  { id: '3',  created_at: '2026-04-03T00:00:00Z', title: 'fos-index.jsx',              content: 'livré 410L',           category: 'artifact', tags: ['FOS-INDEX-DATA.md'],              sort_order: 3 },
