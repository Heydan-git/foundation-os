...
export const SEED_CONTEXT_BLOCKS: ContextBlock[] = [
  ...
  { id: 'C-02', created_at: '2026-04-03T00:00:00Z', sort_order: 2, label: 'DA Void Glass — tokens obligatoires', content: 'Fond : var(--color-bg-canvas)\nAccent : var(--color-accent-brand-primary)\nFonts : Figtree (UI) + JetBrains Mono (code/labels)\nCards : var(--color-bg-card) border var(--color-border-default)\nOrbes : blur(80px), opacity 0.09–0.12, animation drift' },
