...
Pattern d'architecture memoire pour LLMs propose par [[Andrej Karpathy]] (avril 2026) : au lieu de donner des documents bruts a un LLM, lui faire pre-compiler les sources dans un wiki Markdown structure, puis operer le LLM sur ce wiki.
...
- **Human-readable** : le wiki est navigable dans [[Obsidian]] (graph view, search, canvas)
...
Adoption 2026-04-15 (D-WIKI-01) via plugin [[AgriciDaniel|claude-obsidian]].
...
- [[Pinecone]] — extension pour archivage > 1000 pages (vector DB)

## Sources

- [[karpathy-llm-wiki-pattern]] — article original Karpathy
- [[agricidaniel-claude-obsidian]] — implementation reference
