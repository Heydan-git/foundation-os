...
> [!note] **Wikilinks resolvent vault racine (D-VAULT-01)**
> Les wikilinks ci-dessous (`[[01-button]]` etc.) resolvent vers `modules/design-system/docs-supernova/{components,foundations}/*.md`. Vault Obsidian = racine projet (pas juste `wiki/`), donc ils fonctionnent et connectent les 52 pages DS au graph Obsidian.
...
- [[03-spacing]] — Tokens spacing
- [[04-radius]] — Tokens radius
