...
- Prochaine phase : 3 (documentation 5 tiers dans docs/core/communication.md section 1.5 test arbitral)
- Migration auto-memory selective (Phase 5) : 29 fichiers a auditer 1-par-1, 2 probables MIGRATE
