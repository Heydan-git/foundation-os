...
| Product | ✅ P1.5 Phase 9 | `docs/core/product.md` | 9e Core OS — Integration FOS ↔ **Notion only** (pivot P1.5, Asana abandonne). Agent `po-agent` expert Notion 100% (PO elargi). Skill `/po`. Notion 4 DB (Decisions/Plans/Sessions/Tasks). D-PRODUCT-01. |
